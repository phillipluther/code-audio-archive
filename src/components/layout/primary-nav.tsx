...
const NavLink = ({ to, children }: { to: string; children: React.ReactNode }) => (
  <Link
    to={to}
    className="block px-6 py-2 leading-10 outline-offset-[-4px] no-underline hover:underline hover:decoration-solid decoration-2 text-stone-100 bg-stone-700 hover:bg-stone-100 hover:text-stone-700"
  >
    {children}
  </Link>
);
